...
echo   ================================================
echo.
echo     1.  Preview   - show what import would change
echo     2.  Import    - apply repo config to this PC
echo     3.  Export    - save this PC's config to repo
echo     4.  Install   - npm install the extensions
echo     5.  Setup     - import + install (new machine)
echo     6.  Quit
echo.
set "choice="
set /p "choice=  Choose [1-6]: "

if "%choice%"=="1" set "CMD=preview" & goto dispatch
if "%choice%"=="2" set "CMD=import"  & goto dispatch
if "%choice%"=="3" set "CMD=export"  & goto dispatch
if "%choice%"=="4" set "CMD=install" & goto dispatch
if "%choice%"=="5" set "CMD=setup"   & goto dispatch
